...
*/
enum BroadcastLayerID
{
	BCLAYER_SYSTEM = 0,
	BCLAYER_ADMIN,

	BCLAYER_BARSTART,
	BCLAYER_NINJABAR = BCLAYER_BARSTART,
	NUM_BCLAYERS,
};

using CBroadcastID = std::pair<int, int>;
...
public:
	...
	// key = ClientID + LayerID, value = Broadcast
	std::map<CBroadcastID, CBroadcast> m_aBroadcasts;
